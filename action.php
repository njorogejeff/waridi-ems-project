...
if(isset($_POST['action']))
{
	...
	if($_POST['action'] == 'fetch_users')
	{
		...
		if (!empty($_POST['search']['value'])) 
		{
		    ...
		    $filterQuery = " WHERE (name LIKE '%$search%' OR contact LIKE '%$search%' OR email LIKE '%$search%' OR role LIKE '%$search%')";
		}
	...
	if($_POST['action'] == 'fetch_bills')
	{
		...
		// Define the base query
		$query = "
		SELECT bills.id, bills.bill_title, flats.flat_number, flats.block_number, bills.amount, bills.month, bills.paid_amount,bills.transaction_code, bills.created_at FROM $table
		...
		if (!empty($_POST['search']['value'])) 
		{
		    ...
		    $filterQuery = " WHERE (bills.bill_title LIKE '%$search%' OR flats.flat_number LIKE '%$search%' OR bills.amount LIKE '%$search%' OR bills.transaction_code LIKE '%$search%' OR bills.month LIKE '%$search%' OR bills.paid_amount LIKE '%$search%')";
		}
