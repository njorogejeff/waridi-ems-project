...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 21, 2023 at 08:42 PM
...
(31, 32, 30, '2023-10-01', '0000-00-00', '2023-10-19 11:40:47');
...
INSERT INTO `bills` (`id`, `flat_id`, `bill_title`, `amount`, `month`, `paid_date`, `payment_method`, `paid_amount`, `transaction_code`, `created_at`) VALUES
(3, 1, 'Electricity Bill for January 2023', '350.00', '2023-01', '2023-12-02', 'Cash', '350.00', NULL, '2023-02-22 12:56:25'),
(5, 1, 'Electricity Bill for February 2023', '425.00', '2023-02', '2023-03-02', 'Cash', '425.00', NULL, '2023-03-02 12:52:06'),
(6, 30, 'water', '200.00', '2023-10', '2023-10-19', 'Mpesa', '200.00', NULL, '2023-10-19 09:01:02'),
(7, 30, 'Electricity Bill', '1.00', '2023-10', '2023-10-19', 'Mpesa', '1.00', 'KY67SY85768C', '2023-10-19 09:43:26'),
(8, 30, 'Waste', '50.00', '2023-10', '2023-10-21', 'Mpesa', '50.00', 'RJK08M5HGC', '2023-10-21 08:32:56');
...
(7, 1, 'Bill', 6, 'New bill added. Amount: , Month: ', 'bill_payment.php?id=6&action=notification', 'unread', '2023-10-19 09:01:02'),
(8, 1, 'Bill Payment', 6, 'Bill Payment Done by Flat Number - C - 501 for water.', 'bill_payment.php?id=6&action=notification', 'unread', '2023-10-19 09:41:38'),
(9, 1, 'Bill', 7, 'New bill added. Amount: , Month: ', 'bill_payment.php?id=7&action=notification', 'unread', '2023-10-19 09:43:26'),
(10, 1, 'Bill Payment', 7, 'Bill Payment Done by Flat Number - C - 501 for Electricity Bill.', 'bill_payment.php?id=7&action=notification', 'unread', '2023-10-19 12:45:26'),
(11, 1, 'Bill Payment', 7, 'Bill Payment Done by Flat Number - C - 501 for Electricity Bill.', 'bill_payment.php?id=7&action=notification', 'unread', '2023-10-19 12:46:11'),
(12, 1, 'Bill Payment', 7, 'Bill Payment Done by Flat Number - C - 501 for Electricity Bill.', 'bill_payment.php?id=7&action=notification', 'unread', '2023-10-19 12:50:33'),
(13, 1, 'Bill', 8, 'New bill added. Amount: , Month: ', 'bill_payment.php?id=8&action=notification', 'unread', '2023-10-21 08:32:57'),
(14, 1, 'Bill Payment', 8, 'Bill Payment Done by Flat Number - C - 501 for Waste.', 'bill_payment.php?id=8&action=notification', 'unread', '2023-10-21 08:39:03');
...
(32, 'Joseph', '0727083400', 'joseph@gmail.com', '$2y$10$UnNTSj..LSngAFcoGMQYUun17EqzO6.Ho4kUtDGRJCa6zSevsl8Qy', 'user', '2023-10-19 09:33:26'),
(33, 'Amos', '0712345678', 'amos@gmail.com', '$2y$10$jBMM8VjMs7IXG5CNkqbWX.sCq.Aygptcnt7K0.P7Zw3vjc.HAYN46', 'user', '2023-10-19 09:37:02');
...
CREATE TABLE `visitors` (
  ...
  `out_remark` text COLLATE utf8_unicode_ci DEFAULT NULL,
